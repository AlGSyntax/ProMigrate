...
data class JobDetailsResponse(
    val aktuelleVeroeffentlichungsdatum: Map<String, Any>,
    ...
    val eintrittsdatum: Map<String, Any>,
    val ersteVeroeffentlichungsdatum: Map<String, Any>,
    val allianzpartner: String,
    val allianzpartnerUrl: String,
    val titel: String,
    val hashId: String,
    val beruf: String,
    val modifikationsTimestamp: Map<String, Any>,
