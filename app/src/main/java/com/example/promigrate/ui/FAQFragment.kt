...
class FAQFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val questions = listOf(binding.question1, binding.question2, binding.question3, binding.question4, binding.question5,
            binding.question6, binding.question7)

        val answers = listOf(binding.answer1, binding.answer2, binding.answer3, binding.answer4, binding.answer5,
